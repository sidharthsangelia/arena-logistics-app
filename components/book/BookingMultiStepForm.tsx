...
export default function BookingMultiStepForm({ className, onSubmit }: MultiStepFormProps) {
  ...
  const steps = [
    {
      ...
      fields: [
        { name: "senderFirstName", label: "Sender's First Name", type: "text", placeholder: "Ajay" },
        { name: "sendorLastName", label: "Sender's Last Name", type: "text", placeholder: "Singh" },
        { name: "senderEmail", label: "Email", type: "Email", placeholder: "ajay.singh@example.com" },
        { name: "senderPhone", label: "Phone Number", type: "Number", placeholder: "9878766811" },
           { name: "senderAddress", label: "Sender's Address", type: "text", placeholder: "123 Main St" },
        { name: "city", label: "City", type: "text", placeholder: "Delhi" },
        { name: "pinCode", label: "Pin Code", type: "text", placeholder: "10001" },
      ],
    },
    {
      id: "address",
